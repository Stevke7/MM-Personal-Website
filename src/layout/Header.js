...
function Header(props) {
    ...
    return (
        <>
            <ContactModal isMobile={isMobile} setModalShow={setModalShow} show={modalShow} onHide={closeModal}/>
                    <Container >
                        <Row className="py-3 px-4 px-md-0 justify-content-between align-items-center">
                            ...
                            <Col xs={9} md={4} className="d-flex justify-content-end pe-0 ">
                                <button onClick={() => setModalShow(true)} className={`request-modal p-0 px-md-3 py-md-2 ${isMobile && "bg-white"}`}> Request a
