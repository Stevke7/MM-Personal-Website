...
function Cheetah() {
    ...
    return (
        <>
            {!isMobile ? <Container className="px-5 ">
                    <div className="row ">
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={12} className="my-2">
                            <Image className="w-100 h-100" src="/images/cheetahMobile.png"></Image>
                        </Col>
                        <Col md={12}>
                            <div
                                className=" case-about  w-100 h-100 radius20 d-flex flex-column justify-content-center p-5">
                                <h4 className="text-white case-text ">
                                    Cheetah Athletics is a sports and apparel club that provides everything you need to
                                    achieve your sports & fitness goals.
                                    It pushes people to live an active and healthy lifestyle by training, eating and
                                    wearing
                                    better.
                                </h4>
                            </div>
                        ...
                        <Col md={12} className="my-5">
                            <div className=" text-center m-auto ">
                                <h3 className="mb-4 text-gradient-orange">Born to run</h3>
                                <p>Cheetahs are the world’s fastest land animal, capable of reaching speeds of up to
                                    70mph. They
                                    are built for speed, grace, and hunting. <span
                                        className="fw-bold">Cheetah Athletics</span> encompass the spirit of cheetah
                                    and live it’s moto - <span className="fw-bold">Born to run!</span></p>
                                <p>The logo is created by combining a cheetah silhouette, with the lettermarks enclosed
                                    in a
                                    circular shape. The circle represents stability, continuity and perseverance. </p>
                            </div>
                        </Col>
                        <Col md={12} className="my-2">
                            <Image className="w-100 h-100" src="/images/mobileCheetah2.png"></Image>
                        </Col>
                        <Col md={12} className="my-2">
                            <Image className="w-100 h-100" src="/images/mobileCheetah3.png"></Image>
                        </Col>
                        <Col md={12} className="my-2">
                            <Image className="w-100 h-100" src="/images/mobileCheetah3.png"></Image>
                        </Col>
                        <Col md={12} className="my-5">
                            <div className=" text-center m-auto ">
                                <h3><span className='text-gradient-orange'>Perfect fit</span> <br/>and harmony
                                    between
                                    <br/> sports and technology</h3>
                            </div>
                        </Col>
                        <Col md={12} className=' h-400 '>
                            <Image className='radius20  w-100 h-100 ' src="/images/videoPlaceholder.png"></Image>
                        </Col>
                        <div className="d-flex h-400 my-3 scroll align-items-center">
                            <Image className='radius20  w-75 h-100 ' src="/images/videoPlaceholder.png"></Image>
                            <Image className='radius20 mx-2  w-75 h-100 ' src="/images/videoPlaceholder.png"></Image>
                            <Image className='radius20  w-75 h-100 ' src="/images/videoPlaceholder.png"></Image>
                        </div>
                        <Col md={12} className=' h-400 '>
                            <Image className='radius20  w-100 h-100 ' src="/images/videoPlaceholder.png"></Image>
                        </Col>
                        <Col md={12} className=' my-3 h-400 '>
                            <Image className='radius20  w-100 h-100 ' src="/images/videoPlaceholder.png"></Image>
                        </Col>
                        <Col md={12}>
                            <Col md={12} className='radius20 bg-white my-3 p-5 pb-0'>
                                ...
                                <div className="d-flex flex-column justify-content-between align-items-center">
                                    ...
                                    <Col md={6} className="ms-2">
                                        <h3 className='text-black text-center my-5'>Back</h3>
                                        <Image className='radius20 w-100' src="/images/mockup7.png"></Image>
                                    </Col>
                                </div>
                            </Col>
                        ...
                        <Col>
                            <div className="my-5  w-100 text-center m-auto ">
                                <h2> Train good. <br/> Eat good. <br/> Look good.</h2>
                            </div>
                        </Col>
                        <Col md={12}>
                            <Image className='h-100 w-100  ' src="/images/mobileCheetah5.png"></Image>
                        </Col>
                        <Col md={12} className="d-flex my-2 flex-column justify-content-between">
                            <Image className='w-100' src="/images/mobileCheetah6.png"></Image>
                            <div className='w-100 bg-white mt-4'>
                                <div
                                    className="d-flex flex-column align-items-center text-center p-4 justify-content-center h-100">
                                    <h3>Stay up to date.</h3>
                                    <p className=' m-0'>Download our App and stay up to date with the latest news
                                        and
                                        workout programs,
                                        tailor-made for you and your needs. Track your workouts, diet and daily fitness
                                        activities.</p>
