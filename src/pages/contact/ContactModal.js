...
export function ContactModal(props) {
    const { data, setData, id } = useContext(ContactModalContext);
    ...
    return (
        <>
            <Modal
                ...
                centered
                className="modal  d-flex flex-column justify-content-between"
                id='contact-modal'
            ...
            >
                <  >
                    ...
                    <Form onSubmit={onSubmit} className="d-flex flex-column justify-content-between h-100" >
                        <Modal.Body className="p-0 d-flex flex-column justify-content-center px-4">
                            {step}
                        </Modal.Body>
                        <Modal.Footer>
