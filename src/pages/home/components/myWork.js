		...
		<>
			{!isMobile ? (
				<Container className="px-5">
					...
					<Row className="">
						...
						<Col md={5} className=" ">
							<div className="d-flex flex-column justify-content-between h-100">
								<div
									onClick={openAbout}
									className="image-container-left  h-48  cursor-pointer  "
								>
									<Image
										fluid={true}
									...
									<div className={`moreAbout ${showAbout && "active-about"}`}>
										<p className="d-flex align-items-center p-3">
											I'm Miloš, digital designer and content creator based in
											Bosnia & Herzegovina.I started off as a graphic designer,
											but now i do a mix of everthing, from web/design and
											development to media production and much, much more. I'm
											also a big fan of sports.
										</p>
									</div>
								</div>
								<div
								...
								>
									...
									/>
									<div
										className={`moreSkill  ${showSkill && "active-skill  "}`}
									>
					...
					<Col md={12}>
						<div className="bg-primary-darker align-items-center h-100 radius20 mt-5 d-flex flex-md-column flex-lg-row align-items-center justify-content-between ">
							<div className=" w-77 position-relative">
								<p className="f-27 px-5 work-info w-100">
									<span className="fw-bold">
										I’m a digital designer and creator.
									</span>
									<br />
									Designing digital products and experiences, I help brands
									stand out in the digital era.
								</p>
								<div className="checkoutMyWork ">
									<Image className="myWork-img" src="/icons/Arrow.svg"></Image>
									<p>
										Check out <br /> my artwork
									</p>
								</div>
							</div>
							<div className=" ">
								<Image
									className="myWork-img h-100 w-100 "
				...
				<Container>
					...
					<Row>
						...
						<Col lg={5} className="h-100 ">
							<div className="d-flex flex-column h-100 justify-content-between">
								<div
									onClick={openAbout}
									className="image-container-left cursor-pointer my-3 "
								>
									<Image
										fluid={true}
										src="/images/aboutMe.png"
								...
								<div
									onClick={openSkill}
									className="image-container-left cursor-pointer  "
								>
									<Image
										fluid={true}
										src="/images/skils-img.png"
					...
					<Col md={12}>
						<div className="bg-primary  h-100 radius20 mt-4  ">
							...
							<div className="h-100 w-100 ">
								<Image
									className="myWork-img w-100"
									src="/icons/Images-group-mobile.png"
								></Image>
							</div>
						</div>
					</Col>
